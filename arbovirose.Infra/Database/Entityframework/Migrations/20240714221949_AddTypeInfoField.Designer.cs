...
namespace arbovirose.Infra.Database.EntityFramework.Migrations
{
    ...
    [Migration("20240714221949_AddTypeInfoField")]
    partial class AddTypeInfoField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("arbovirose.Domain.Entities.InfoHomeEntity", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("TypeInfo", "arbovirose.Domain.Entities.InfoHomeEntity.TypeInfo#TypeInfo", b1 =>
                        {
                            b1.IsRequired();
